  ...
  return (
    <aside className="hidden lg:flex flex-col w-64 border-r border-border bg-card min-h-screen">
      ...
      <div className="flex items-center gap-3 px-6 py-6 border-b border-border">
        <div className="flex items-center justify-center size-10 rounded-2xl bg-primary/3 border border-primary/10">
          <Logo size={30} />
        </div>
        <div className="flex flex-col">
          <span className="text-base font-bold tracking-tight text-foreground">SALVIA</span>
          <span className="text-xs text-muted-foreground leading-none">Admin Panel</span>
        </div>
      </div>
